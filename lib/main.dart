...
Future<List<Pegawai>> fetchPegawais(http.Client client) async {
  final response =
      await client.get('https://rezadart.000webhostapp.com/PegawaiReadDatajson.php');
...
class Pegawai {
  ...
  final String pendidikan_terahir;

  Pegawai({this.nip, this.nama_pegawai, this.depatemen, this.jabatan, this.pendidikan_terahir});
  ...
  factory Pegawai.fromJson(Map<String, dynamic> json) {
    return Pegawai(
      ...
      pendidikan_terahir: json['pendidikan_terahir'] as String,
    );
  }
}
